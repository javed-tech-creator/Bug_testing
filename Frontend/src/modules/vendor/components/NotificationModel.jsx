...
const NotificationModel = ({ visible, onClose, modalRef,notifications = [], refetch,setNotifications }) => {
...
const markAsRead = async (id) => {
  ...
  return (
   <div
      ref={modalRef}
      className={`fixed top-14 right-0 w-96 bg-white rounded-l-xl shadow-2xl z-50 overflow-hidden border border-gray-200 transition-transform duration-300 ease-in-out
