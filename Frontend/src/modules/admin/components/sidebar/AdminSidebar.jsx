  ...
  const navItems = [
    ...
    },
    {
      ...
      children: [
        ...
        {
          name: "Add Contractor",
          link: "/admin/contractor-management",
        },
        {
          name: "Add Freelancer",
          link: "/admin/freelancer-management",
        },
        {
          name: "Add Partner",
        ...
        {
          name: "Add Franchise",
          link: "/admin/franchise-management",
        },
      ],
    },
    {
      ...
      children: [
        { name: "Location Hierarchy", link: "/admin/location-hierarchy" },
        {
          name: "Department & Designation",
          link: "/admin/department-designation",
        },
      ],
    },
    {
