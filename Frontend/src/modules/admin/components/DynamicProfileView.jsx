      ...
      <div className="max-w-8xl mx-auto space-y-6">
        ...
        <div className="bg-white rounded-md shadow-lg   border border-gray-200 p-2 sm:p-4">
          <div className="flex items-center justify-between flex-wrap gap-4">
            ...
            <button
              onClick={() => navigate(-1)}
              className="flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-gray-700 to-gray-800 text-white text-sm font-semibold rounded-xl   hover:scale-105 transition-all duration-200"
            >
              <ArrowLeft size={18} />
              Back
            </button>
              ...
              <div className="flex flex-col items-center gap-4">
                <div className="relative group">
                  ...
                  <img
                    ...
                    alt="Profile"
                    className="relative w-32 h-32 rounded-full border-4 border-white  object-cover ring-4 ring-indigo-100"
                  />
                </div>
        ...
        <div className="bg-white rounded-md shadow-lg  border border-gray-200 p-6  transition-all duration-300">
          <div className="flex items-center gap-3 border-b border-gray-200 pb-4 mb-6">
            <div className="w-11 h-11 bg-gradient-to-br from-purple-500 to-pink-600 rounded-xl flex items-center justify-center ">
