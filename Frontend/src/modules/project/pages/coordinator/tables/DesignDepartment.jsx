...
const DesignDepartment = () => {
  ...
  // --- Mock Data: Design Department Table ---
  const designData = [
    {
      id: 1,
  ...
  const ActionButtons = ({ row }) => (
    ...
    >
      ...
      <button
        ...
        onClick={() => navigate(`/project/design-detail/${row.id}`)}
        id={`a${row.id}`}
      >
        <Eye size={16} />
      </button>
  ...
  return (
    <div className="">
      ...
      <div className="custom-table-styles mb-8">
        <Table data={designData} columnConfig={designColumns} />
      </div>
