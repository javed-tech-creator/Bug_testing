...
const RecceDepartment = () => {
  ...
  // --- Mock Data: Declined Works Table ---
  const declinedData = [
    {
      id: 1,
      department: "Recce",
...
const ActionButtons = ({ row }) => (
  <div className="flex items-center justify-center gap-2">
    ...
    <button
      ...
      onClick={() => navigate("/project/new-flex-sign-board")}
    >
      <Eye size={16} />
    </button>
    <button
  ...
  // --- Column Config: Declined Works Table ---
  ...
  return (
    <div className="">
      ...
      <div className="custom-table-styles mb-8">
        <Table data={recceData} columnConfig={recceColumns} />
      </div>
      ...
      {/* ------------------ TABLE 3: Declined WORKS ------------------ */}

      {/* Header Section */}
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-4 mt-8 bg-white border border-gray-200 rounded-lg px-4 py-3 shadow-sm">
        <div className="flex items-center gap-4">
          <h1 className="text-xl font-bold text-gray-900">Declined Works</h1>
        </div>
      ...
      {/* Waiting Table */}
      <div className="custom-table-styles">
        <Table data={declinedData} columnConfig={declinedColumns} />
      </div>
