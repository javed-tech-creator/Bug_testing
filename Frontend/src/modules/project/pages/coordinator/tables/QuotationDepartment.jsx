...
const QuotationDepartment = () => {
  const navigate = useNavigate();
  // --- Mock Data: Quotation Department Table ---
  const quotationData = [
    {
      id: 1,
      clientName: "Aman",
  ...
  const ActionButtons = ({ row }) => (
    ...
    >
      ...
      <button
        ...
        onClick={() => navigate(`/project/quotation-detail/${row.id}`)}
        id={`a${row.id}`}
      >
        <Eye size={16} />
      </button>
  ...
  return (
    <div className="">
      ...
      <div className="custom-table-styles mb-8">
        <Table data={quotationData} columnConfig={quotationColumns} />
      </div>
...
export default QuotationDepartment;
