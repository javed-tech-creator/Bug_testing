...
const PRDepartment = () => {
  ...
  // --- Mock Data: PR Department Table ---
  // Based on the screenshot, the columns still reference "Design Executive" and "Design Deadline"
  const prData = [
    {
      id: 1,
  ...
  const prColumns = {
    ...
    executive: { label: "Design Executive" }, // Kept as per screenshot
    urgency: {
      label: "Urgency",
    ...
    deadline: {
      label: "Design Deadline", // Kept as per screenshot
      render: (val) => (
  ...
  return (
    <div className="">
      ...
      <div className="custom-table-styles mb-8">
        <Table data={prData} columnConfig={prColumns} />
      </div>
