...
const ManagerProductionDepartment = () => {
  ...
  const columnConfig = {
    ...
    subDept: {
      ...
      render: (val) => {
        const styles = {
          Fabrication: "bg-red-50 text-red-600",
          Printing: "bg-orange-50 text-orange-500",
          "Machine Work": "bg-blue-50 text-blue-600",
        };
        return (
          <span className={`px-3 py-1 rounded text-xs font-medium ${styles[val]}`}>
            {val}
...
export default ManagerProductionDepartment;
