...
const ManagerInstallationDepartment = () => {
  ...
  const data = [
    {
      ...
      priority: 1,
      time: "10:00 AM",
      installationDate: "Nov 15, 2024 - 10:00 AM",
  ...
  const columnConfig = {
    ...
    time: { label: "Time" },
    installationDate: { label: "Installation Date" },
...
export default ManagerInstallationDepartment;
