...
const designData = [
  {
    ...
    urgency: "High",
    priority: "1",
    designDeadline: "Nov 15, 2024 - 10:00AM",
    completionDate: "Nov 15, 2024",
    status: "Pending",
  },
  {
    productName: "LED Channel Letter Signage",
    ...
    urgency: "High",
    priority: "1",
    designDeadline: "Nov 16, 2024 - 11:00AM",
    completionDate: "Nov 16, 2024",
    status: "Pending",
  },
  {
    ...
    urgency: "Low",
    priority: "2",
    designDeadline: "Nov 17, 2024 - 12:00PM",
    completionDate: "Nov 17, 2024",
  ...
  },
  {
    ...
    urgency: "Low",
    priority: "3",
    designDeadline: "Nov 18, 2024 - 01:00PM",
    completionDate: "Nov 18, 2024",
    status: "Completed",
  },
  {
    ...
    urgency: "High",
    priority: "1",
    designDeadline: "Nov 19, 2024 - 02:00PM",
    completionDate: "Nov 19, 2024",
    status: "Completed",
  },
  {
    productName: "LED Channel Letter Signage",
    ...
    urgency: "Low",
    priority: "2",
    designDeadline: "Nov 20, 2024 - 03:00PM",
...
const columnConfig = {
  ...
  typeOfWork: { label: "Type of Work" },
  designExce: { label: "Design Executive" },
  urgency: {
    label: "Urgency",
    render: (val) => (
      <span
  ...
  designDeadline: { label: "Design Deadline" },
  ...
  return (
    <div>
      ...
      <div className="flex flex-wrap items-center justify-between mb-5 bg-white px-4 py-3 rounded-lg border border-slate-200 shadow-sm">
        ...
        <div className="flex items-center gap-3">
          {["Urgency", "Status", "Design Executive"].map((f) => (
            <button
              key={f}
      ...
      <div className="overflow-x-auto bg-white rounded shadow">
        <Table data={designData} columnConfig={columnConfig} />
      </div>
