...
const ProductionSidebar = () => {
  ...
  const navItems = [
    { name: "Dashboard", icon: <MdSpaceDashboard size={20} />, link: "/production/dashboard" },
    // {
    //   name: "Department Management",
    //   icon: <FiBriefcase size={20} />,
    //   children: [
    //     { name: "Location Hierarchy", link: "#" },
    //     { name: "Department & Designation & Actions", link: "#" },
    //   ],
    // },
    {
      name: "JobCard Management",
      icon: <Icons.LucideFileCog size={20} />,
      link: "/production/jobcard",
    },
    {
