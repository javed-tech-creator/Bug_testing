...
import { Lightbulb, ChevronDown, ClipboardList, ArrowLeft, Eye } from "lucide-react";
import { useNavigate } from "react-router-dom";

const TodaysQuotations = () => {
    ...
    actions: {
      ...
      render: (_val, row) => (
        <div className="flex gap-2">
          <button
            title="View"
            onClick={() => navigate(`/quotation/quotation-detail/${row.id}`, { state: { readonly: true } })}
          ...
          <button
            ...
            onClick={() => navigate(`/quotation/form/${row.id}`)}
            className="bg-blue-600 hover:bg-blue-700 text-white p-1.5 rounded-md transition-colors cursor-pointer"
          >
...
export default TodaysQuotations;
