...
import ClientDiscussionModal from "../components/ClientDiscussionModal";
...
import ReviewDynamicForm from "../components/ReviewDynamicForm";
const UpcomingQuotationDetailPage = () => {
  useParams();
  ...
  const [checklist, setChecklist] = useState({
    ...
    "Product Requirements": false,
    "Uploaded Images": false,
    "Uploaded Videos": false,
    "Installation Details": false,
    "Raw Recce": false,
    "Data From Client": false,
    "Accurate Measurements Taken": false,
    "Instructions / Remarks": false,
    "All Signage Name (Product Name) Confirmed": false,
  ...
  return (
    <div className="">
      ...
      {/* <div className="bg-white p-4 rounded-lg shadow-sm mb-4 border border-gray-200">
        <h2 className="font-bold text-sm mb-4">Assigned By</h2>
        <div className="grid grid-cols-4 gap-4 mb-4">
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-30">
          <div className="relative w-full max-w-6xl max-h-[95vh] p-2 sm:p-4 md:p-6 flex flex-col items-center">
            <button
              ...
              className="fixed top-4 right-4 sm:top-6 sm:right-6 md:top-8 md:right-8 z-30 bg-black/60 rounded-full p-1.5 text-white hover:text-gray-300 transition-colors cursor-pointer focus:outline-none"
              style={{ lineHeight: 0 }}
            >
...
export default UpcomingQuotationDetailPage;
