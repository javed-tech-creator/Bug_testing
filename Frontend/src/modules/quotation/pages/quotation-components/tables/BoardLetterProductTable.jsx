                ...
                <tr>
                  ...
                  <td className={`${tdClass} w-20`}>
                    <input
                      ...
                      onChange={(e) =>
                        clickable && handleProductChange("board", e.target.value)
                      }
                      {...getInputProps()}
                    />
                  </td>
                  <td className={`${tdClass} ${colWidths.thickness}`}>
                    <input
                      ...
                      onChange={(e) =>
                        clickable && handleProductChange("thickness", e.target.value)
                      }
                      {...getInputProps()}
                    />
                  </td>
                  ...
                  <td className={`${tdClass} ${colWidths.length}`}>
                    <input
                      ...
                      onChange={(e) =>
                        clickable && handleProductChange("lengthInch", e.target.value)
                      }
                      {...getInputProps()}
                    />
                  </td>
                  ...
                  <td className={`${tdClass} ${colWidths.height}`}>
                    <input
                      ...
                      onChange={(e) =>
                        clickable && handleProductChange("heightInch", e.target.value)
                      }
                      {...getInputProps()}
                    />
                  </td>
                  ...
                  <td className={`${tdClass} ${colWidths.quantity}`}>
                    <input
                      ...
                      onChange={(e) =>
                        clickable && handleProductChange("quantity", e.target.value)
                      }
                      {...getInputProps()}
                    />
                  </td>
                  ...
                  {showLsp && (
                    <td className={`${tdClass} ${colWidths.lsp}`}>
                      <input
                        ...
                        onChange={(e) =>
                          clickable && handleProductChange("lsp", e.target.value)
                        }
                  ...
                  <tr key={i}>
                    <td className={`${tdClass} ${colWidths.sNo}`}>
                      <input
                        value={row.letters}
                        onChange={(e) =>
                          clickable && handleLetterChange(i, "letters", e.target.value)
                        }
                        {...getInputProps()}
                      />
                    </td>
                    <td className={`${tdClass} ${colWidths.thickness}`}>
                      <input
                        value={row.thickness}
                        onChange={(e) =>
                          clickable && handleLetterChange(i, "thickness", e.target.value)
                        }
                        {...getInputProps()}
                      />
                    </td>
                    ...
                    >
                      <input
                        value={row.length}
                        onChange={(e) =>
                          clickable && handleLetterChange(i, "length", e.target.value)
                        }
                        {...getInputProps()}
                      />
                    </td>
                    ...
                    >
                      <input
                        value={row.height}
                        onChange={(e) =>
                          clickable && handleLetterChange(i, "height", e.target.value)
                        }
                        {...getInputProps()}
                      />
                    </td>
                    ...
                    >
                      <input
                        value={row.quantity}
                        onChange={(e) =>
                          clickable && handleLetterChange(i, "quantity", e.target.value)
                        }
                        {...getInputProps()}
                      />
                    </td>
                    <td className={`${tdClass} ${colWidths.rate}`}>
                      <input
                        value={row.rate}
                        onChange={(e) =>
                          clickable && handleLetterChange(i, "rate", e.target.value)
                        }
                        {...getInputProps()}
                      />
                    </td>
                    ...
                    {showLsp && (
                      <td className={`${tdClass} ${colWidths.lsp}`}>
                        <input
                          value={row.lsp}
                          onChange={(e) =>
                            clickable && handleLetterChange(i, "lsp", e.target.value)
                          }
                          placeholder="Write your selling point"
                          {...getInputProps("placeholder-gray-400")}
                        />
