...
import MorningQuotationTeam from "./MorningQuotationTeam";
...
const MorningQuotationManager = () => {
  ...
  const handleSubmit = async () => {
    ...
    console.log("Submitting Morning Report:", submitPayload);

    try {
      // TODO: Replace with actual API endpoint
      // const response = await fetch('/api/quotation/morning-report', {
      //   method: 'POST',
  ...
  return (
    <div className="max-w-7xl mx-auto">
      <PageHeader title="Quotation Manager - Morning Planning" />
      ...
      <div className="bg-white border rounded-md p-4 mb-4 flex justify-between">
        ...
        <div className="text-sm">{planRows.length} Quotations Planned</div>
      </div>
      ...
      {reportingMode === "self" ? (
        <div className="grid grid-cols-12 gap-4">
          ...
          <div className="col-span-7 bg-white border rounded-md p-4">
            <h3 className="font-medium mb-3 flex items-center gap-2">
              ...
              Today’s Quotation Plan ({planRows.length})
            </h3>
        ...
        <MorningQuotationTeam onDataChange={setTeamReportData} />
      )}
...
export default MorningQuotationManager;
