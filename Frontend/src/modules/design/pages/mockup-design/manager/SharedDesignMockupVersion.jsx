...
const SharedDesignMockupVersion = () => {
  ...
  return (
    <div className="px-5">
      <DesignsHeader
        title="Shared Mockup's Version Detail"
      ...
      <div className=" mt-4 space-y-4  rounded-sm">
        {designMockup.map((mockup) => (
              ...
              <> */}
                {mockup.status === "pending" ? (
                  ...
                  <div className="flex gap-2">
                    <button
                      onClick={() => updateDesignStatus(mockup.id, "approved")}
          ...
          text-white text-sm px-3 py-1.5 rounded"
                    ...
                    <button
                      onClick={() =>
                        updateDesignStatus(mockup.id, "modification")
                      }
...
export default SharedDesignMockupVersion;
