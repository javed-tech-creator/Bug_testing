    ...
    <div className="border rounded bg-white p-4 space-y-4">
      ...
      <div className="flex justify-between items-center">
        <span className="inline-block bg-blue-100 text-blue-600 px-3 py-1 rounded text-sm">
          Design Option – {String(index + 1).padStart(2, "0")}
        </span>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-5">
        ...
        <div className="md:col-span-2">
          <FileInput
            ...
            onChange={(e) => onChange(data.id, "designFile", e.target.files[0])}
          />
        </div>
        ...
        <div className="md:col-span-2">
          <FileInput
            ...
            onChange={(e) => onChange(data.id, "assetsFile", e.target.files[0])}
          />
        </div>
...
export default DesignAdditionalForm;
