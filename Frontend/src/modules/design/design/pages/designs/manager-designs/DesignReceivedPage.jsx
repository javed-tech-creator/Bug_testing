...
import { Check, CheckCircle, Download, Eye, Star } from "lucide-react";
...
const DesignReceivedPage = () => {
  ...
  const handleAction = (action) => {
    navigate(`/design/manager/designs/assigned-${action}/${type}/${id}`, {
      state: {
        title,
        page: action,
      },
  ...
  return (
    <div className="px-5">
      <DesignSimpleHeader
        ...
        showLog={true}
        clientDiscussionLog={() => console.log("Discussion log")}
        showDesignStarted={true}
        designStarted="11/07/25 - 12:00PM"
      />
  ...
  `}
        ...
        <div className="rounded-sm shadow-sm border">
          ...
          <div className="px-4 py-3 border-b">
            <h2 className="text-lg font-semibold">
              Design Manager Receiving Checklist
            </h2>
          </div>
...
export default DesignReceivedPage;
