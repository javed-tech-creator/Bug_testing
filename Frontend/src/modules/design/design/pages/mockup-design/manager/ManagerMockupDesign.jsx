import { useGetAllUploadedMockupQuery, useGetAllVersionForApprovalDesignQuery, useGetAllViewMockUpQuery } from "@/api/design/common_workflow/view-design-option.api";
...
const ManagerMockupDesign = () => {
  ...
  const handleMeasurementForQuotation = () => { };
