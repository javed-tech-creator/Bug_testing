...
const DesignApproveddetailsCard = ({ heading, title, data }) => {
  return (
    <div className="border rounded bg-white space-y-4">
      ...
      <div className="relative flex flex-wrap justify-between items-center px-2 gap-2">
        ...
        {data?.approved && (
          <div className="py-1 px-2 absolute rounded-md right-35 bg-blue-600 text-white  hover:bg-blue-700 border ">
            Approved By Client
          </div>
        )}
...
export default DesignApproveddetailsCard;
