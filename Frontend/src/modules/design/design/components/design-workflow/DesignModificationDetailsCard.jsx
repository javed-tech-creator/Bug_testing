...
const DesignModificationDetailsCard = ({ data }) => {
  return (
    <div className="border rounded bg-white space-y-4">
      ...
      <div className="flex justify-between items-center border-b bg-white rounded px-4 py-2">
        ...
        <h2 className="text-lg font-semibold text-gray-800">
          Selected Design Option Details
        </h2>
      ...
      {data.clientFeedback && (
        ...
        <label className="font-medium text-sm">Client Feedback</label>
        <textarea
          readOnly
          rows={1}
...
export default DesignModificationDetailsCard;
