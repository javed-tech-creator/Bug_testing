    ...
    sites: [
      {
        ...
        time: 3,
        status: "completed",
        remark: "Evening follow-up completed",
      },
      {
        ...
        time: 2,
        status: "progress",
        remark: "Final measurements in progress",
      },
    ],
  },
  {
...
function EveningTeam({ onDataChange }) {
      ...
      {selectedUser && (
        <div className="bg-white border rounded-md p-4">
          <h3 className="font-semibold mb-3">
            {selectedUser.name} – Evening Report
          </h3>
