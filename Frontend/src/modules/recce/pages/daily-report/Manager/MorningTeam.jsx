...
function MorningTeam({ onDataChange }) {
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="bg-white border-t-4 border-black rounded-md shadow p-4">
          <div className="flex justify-between items-center">
            <div>
              <div className="text-gray-600 text-sm">Recce Executive</div>
              <div className="text-2xl font-bold">
                {teamSummary.recceExecutive}
              </div>
            </div>
        ...
        <div className="bg-white border-t-4 border-black rounded-md shadow p-4">
          <div className="flex justify-between items-center">
            <div>
              <div className="text-gray-600 text-sm">Total Recce</div>
              <div className="text-2xl font-bold">
                {teamSummary.totalRecce}
              </div>
            </div>
            <div className="p-2 bg-black rounded-md">
      ...
      {selectedUser && (
        <div className="bg-white border rounded-md p-4">
          <h3 className="font-semibold mb-3">
            {selectedUser.name} – Morning Plan
          </h3>
