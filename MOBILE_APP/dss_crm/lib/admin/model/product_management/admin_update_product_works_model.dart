class UpdateAdminProductWorksModelResponse {
  bool? success;
  String? message;
  Data? data;

  UpdateAdminProductWorksModelResponse({this.success, this.message, this.data});

  UpdateAdminProductWorksModelResponse.fromJson(Map<String, dynamic> json) {
