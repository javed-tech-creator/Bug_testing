...
class AddNewContractorAtAdminScreen extends StatefulWidget {
  const AddNewContractorAtAdminScreen({Key? key}) : super(key: key);

  @override
  State<AddNewContractorAtAdminScreen> createState() => _AddNewContractorAtAdminScreenState();
}

class _AddNewContractorAtAdminScreenState extends State<AddNewContractorAtAdminScreen> {
  ...
  Future<void> handleSubmit() async {
    ...
    final adminMainProvider = context.read<AdminMainApiProvider>();
    ...
    await adminMainProvider.addNewContractorAtAdmin(
      context: context,
      contactPersonName: contactPersonNameController.text.trim(),
      contactNumber: contactNumberController.text.trim(),
