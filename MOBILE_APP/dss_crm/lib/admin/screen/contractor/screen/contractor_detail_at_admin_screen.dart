...
class ContractorDetailsBottomSheet extends StatefulWidget {
  final String vendorId;

  const ContractorDetailsBottomSheet({Key? key, required this.vendorId})
    : super(key: key);

  @override
  State<ContractorDetailsBottomSheet> createState() =>
      _ContractorDetailsBottomSheetState();
  ...
  static void show(BuildContext context, String vendorId) {
    showModalBottomSheet(
      ...
      builder: (context) => ContractorDetailsBottomSheet(vendorId: vendorId),
    );
  }
}

class _ContractorDetailsBottomSheetState extends State<ContractorDetailsBottomSheet> {
  @override
  void initState() {
    super.initState();
