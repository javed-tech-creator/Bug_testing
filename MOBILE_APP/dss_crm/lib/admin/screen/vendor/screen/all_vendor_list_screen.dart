import 'package:dss_crm/admin/screen/vendor/screen/add_new_vendor_at_admin_screen.dart';
import 'package:dss_crm/admin/screen/vendor/screen/update_vendor_details_at_admin_screen.dart';
...
class AllVendorListAtAdminScreen extends StatefulWidget {
  const AllVendorListAtAdminScreen({Key? key}) : super(key: key);

  @override
  State<AllVendorListAtAdminScreen> createState() =>
      _AllVendorListAtAdminScreenState();
}

class _AllVendorListAtAdminScreenState
    extends State<AllVendorListAtAdminScreen> {
  ...
  void _loadVendors() {
    ...
    if (_selectedFilter == 'All') {
      provider.getAllVendorListAtAdmin(context, page: _currentPage, limit: _limit,isActive:  null);
    } else {
      bool isActive = _selectedFilter == 'Active';
      provider.getAllVendorListAtAdmin(context,page:  _currentPage, limit: _limit,isActive:  isActive);
    }
  }
  ...
  void _loadMoreVendors() async {
    ...
    if (response?.data?.data != null) {
      ...
      if (_currentPage < totalPages) {
        ...
        if (_selectedFilter == 'All') {
          await provider.getAllVendorListAtAdmin(
            context,
           page:  _currentPage,
           limit:  _limit,
          isActive:   null,
          ...
          IconButton(
            ...
            onPressed: () async  {
              final result = await Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => AddNewVendorAtAdminScreen(),
                ),
              );
              ...
              builder: (context, provider, child) {
                ...
                if (response?.data?.data == null ||
                  ...
                  return _buildEmptyState(
                    ...
                    subtitle: 'Start by adding your first vendor',
                  );
                }
        ...
        child: InkWell(
          ...
          onTap: () {
            ...
            showModalBottomSheet(
              ...
              builder: (context) => VendorDetailsBottomSheet(
                    ...
                    InkWell(
                      onTap: () async {
                        final result = await Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => UpdateVendorAtAdminScreen(vendorId: vendor.sId!),
                          ),
                        );
