...
class VendorDetailsBottomSheet extends StatefulWidget {
  ...
  const VendorDetailsBottomSheet({Key? key, required this.vendorId})
    : super(key: key);

  @override
  State<VendorDetailsBottomSheet> createState() =>
      _VendorDetailsBottomSheetState();
  ...
  static void show(BuildContext context, String vendorId) {
    showModalBottomSheet(
      ...
      builder: (context) => VendorDetailsBottomSheet(vendorId: vendorId),
    );
  }
}
...
class _VendorDetailsBottomSheetState extends State<VendorDetailsBottomSheet> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      provider.clearSingleVendorDetail(); // Assuming you have this method
