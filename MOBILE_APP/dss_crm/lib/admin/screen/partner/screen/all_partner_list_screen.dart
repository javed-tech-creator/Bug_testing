...
import 'package:dss_crm/admin/screen/partner/screen/add_new_partner_at_admin_screen.dart';
import 'package:dss_crm/admin/screen/partner/screen/partner_detail_at_admin_screen.dart';
import 'package:dss_crm/admin/screen/partner/screen/update_partner_details_at_admin_screen.dart';
...
class AllPartnerListAtAdminScreen extends StatefulWidget {
  const AllPartnerListAtAdminScreen({Key? key}) : super(key: key);

  @override
  State<AllPartnerListAtAdminScreen> createState() =>
      _AllPartnerListAtAdminScreenState();
}

class _AllPartnerListAtAdminScreenState
    extends State<AllPartnerListAtAdminScreen> {
  ...
  void _loadVendors() {
    ...
    if (_selectedFilter == 'All') {
      provider.getAllPartnerListAtAdmin(context,page:  _currentPage, limit: _limit,isActive:  null);
    } else {
      bool isActive = _selectedFilter == 'Active';
      provider.getAllPartnerListAtAdmin(context,page:  _currentPage, limit: _limit,isActive:  isActive);
    }
  }
  ...
  void _loadMoreVendors() async {
    ...
    if (response?.data?.data != null) {
      ...
      if (_currentPage < totalPages) {
        ...
        if (_selectedFilter == 'All') {
          await provider.getAllPartnerListAtAdmin(
            context,
           page:  _currentPage,
           limit:  _limit,
           isActive:  null,
          ...
          IconButton(
            ...
            onPressed: () async  {
              final result = await Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => AddNewPartnerAtAdminScreen(),
                ),
              );
        ...
        child: InkWell(
          ...
          onTap: () {
            ...
            showModalBottomSheet(
              ...
              builder: (context) => PartnerDetailsBottomSheet(
                    ...
                    InkWell(
                      onTap: () async {
                        final result = await Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => UpdatePartnerAtAdminScreen(vendorId: vendor.sId!),
                          ),
                        );
