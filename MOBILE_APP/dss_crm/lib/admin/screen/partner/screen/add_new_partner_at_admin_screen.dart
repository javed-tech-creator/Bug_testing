...
class AddNewPartnerAtAdminScreen extends StatefulWidget {
  const AddNewPartnerAtAdminScreen({Key? key}) : super(key: key);

  @override
  State<AddNewPartnerAtAdminScreen> createState() => _AddNewPartnerAtAdminScreenState();
}

class _AddNewPartnerAtAdminScreenState extends State<AddNewPartnerAtAdminScreen> {
  ...
  Future<void> handleSubmit() async {
    ...
    await adminMainProvider.addNewPartnerAtAdmin(
      context: context,
      contactPersonName: contactPersonNameController.text.trim(),
      contactNumber: contactNumberController.text.trim(),
