...
import 'package:dss_crm/admin/screen/freelancer/screen/add_new_freelancer_at_admin_screen.dart';
import 'package:dss_crm/admin/screen/freelancer/screen/freelancer_detail_at_admin_screen.dart';
import 'package:dss_crm/admin/screen/freelancer/screen/update_freelancer_details_at_admin_screen.dart';
...
class AllFreelancerListAtAdminScreen extends StatefulWidget {
  const AllFreelancerListAtAdminScreen({Key? key}) : super(key: key);

  @override
  State<AllFreelancerListAtAdminScreen> createState() =>
      _AllFreelancerListAtAdminScreenState();
}

class _AllFreelancerListAtAdminScreenState
    extends State<AllFreelancerListAtAdminScreen> {
  ...
  void _loadVendors() {
    ...
    if (_selectedFilter == 'All') {
      provider.getAllFreelancerListAtAdmin(context, page: _currentPage,limit:  _limit,isActive:  null);
    } else {
      bool isActive = _selectedFilter == 'Active';
      provider.getAllFreelancerListAtAdmin(context, page: _currentPage, limit: _limit,isActive:  isActive);
    }
  }
  ...
  void _loadMoreVendors() async {
    ...
    if (response?.data?.data != null) {
      ...
      if (_currentPage < totalPages) {
        ...
        if (_selectedFilter == 'All') {
          await provider.getAllFreelancerListAtAdmin(
            context,
           page:  _currentPage,
           limit:  _limit,
           isActive:  null,
          ...
          IconButton(
            ...
            onPressed: () async  {
              final result = await Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => AddNewFreelancerAtAdminScreen(),
                ),
              );
              ...
              builder: (context, provider, child) {
                ...
                if (response?.data?.data == null ||
                  ...
                  return _buildEmptyState(
                    ...
                    title: 'No Freelancer Yet',
                    subtitle: 'Start by adding your first freelancer',
                  );
                }
        ...
        child: InkWell(
          ...
          onTap: () {
            ...
            showModalBottomSheet(
              ...
              builder: (context) => FreelancerDetailsBottomSheet(
                    ...
                    InkWell(
                      onTap: () async {
                        final result = await Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => UpdateFreelancerAtAdminScreen(vendorId: vendor.sId!),
                          ),
                        );
