...
class FreelancerDetailsBottomSheet extends StatefulWidget {
  ...
  const FreelancerDetailsBottomSheet({Key? key, required this.vendorId})
    : super(key: key);
  ...
  static void show(BuildContext context, String vendorId) {
    showModalBottomSheet(
      ...
      builder: (context) => FreelancerDetailsBottomSheet(vendorId: vendorId),
    );
  }
}

class _FreelancerDetailsBottomSheetState extends State<FreelancerDetailsBottomSheet> {
  @override
  void initState() {
    super.initState();
