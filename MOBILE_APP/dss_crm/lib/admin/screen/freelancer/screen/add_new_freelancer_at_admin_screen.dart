...
class AddNewFreelancerAtAdminScreen extends StatefulWidget {
  const AddNewFreelancerAtAdminScreen({Key? key}) : super(key: key);

  @override
  State<AddNewFreelancerAtAdminScreen> createState() => _AddNewFreelancerAtAdminScreenState();
}

class _AddNewFreelancerAtAdminScreenState extends State<AddNewFreelancerAtAdminScreen> {
  ...
  Future<void> handleSubmit() async {
    ...
    await adminMainProvider.addNewFreelancertAdmin(
      context: context,
      contactPersonName: contactPersonNameController.text.trim(),
      contactNumber: contactNumberController.text.trim(),
