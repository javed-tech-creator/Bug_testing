...
class AddNewFranchisetAdminScreen extends StatefulWidget {
  const AddNewFranchisetAdminScreen({Key? key}) : super(key: key);

  @override
  State<AddNewFranchisetAdminScreen> createState() => _AddNewFranchisetAdminScreenState();
}

class _AddNewFranchisetAdminScreenState extends State<AddNewFranchisetAdminScreen> {
  ...
  Future<void> handleSubmit() async {
    ...
    await adminMainProvider.addNewFranchiseAtAdmin(
      context: context,
      contactPersonName: contactPersonNameController.text.trim(),
      contactNumber: contactNumberController.text.trim(),
