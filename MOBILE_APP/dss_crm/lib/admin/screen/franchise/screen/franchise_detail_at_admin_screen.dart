...
class FranchiseDetailsBottomSheet extends StatefulWidget {
  final String vendorId;

  const FranchiseDetailsBottomSheet({Key? key, required this.vendorId})
    : super(key: key);

  @override
  State<FranchiseDetailsBottomSheet> createState() =>
      _FranchiseDetailsBottomSheetState();
  ...
  static void show(BuildContext context, String vendorId) {
    showModalBottomSheet(
      ...
      builder: (context) => FranchiseDetailsBottomSheet(vendorId: vendorId),
    );
  }
}

class _FranchiseDetailsBottomSheetState extends State<FranchiseDetailsBottomSheet> {
  @override
  void initState() {
    super.initState();
