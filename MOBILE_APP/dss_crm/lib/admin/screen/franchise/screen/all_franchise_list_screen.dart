...
import 'package:dss_crm/admin/screen/franchise/screen/add_new_franchise_at_admin_screen.dart';
import 'package:dss_crm/admin/screen/franchise/screen/franchise_detail_at_admin_screen.dart';
import 'package:dss_crm/admin/screen/franchise/screen/update_franchise_details_at_admin_screen.dart';
...
class AllFranchiseListAtAdminScreen extends StatefulWidget {
  const AllFranchiseListAtAdminScreen({Key? key}) : super(key: key);

  @override
  State<AllFranchiseListAtAdminScreen> createState() =>
      _AllFranchiseListAtAdminScreenState();
}

class _AllFranchiseListAtAdminScreenState
    extends State<AllFranchiseListAtAdminScreen> {
  ...
  void _loadVendors() {
    ...
    if (_selectedFilter == 'All') {
      provider.getAllFranchiseListAtAdmin(context,page:  _currentPage,limit:  _limit,isActive:  null);
    } else {
      bool isActive = _selectedFilter == 'Active';
      provider.getAllFranchiseListAtAdmin(context,page:  _currentPage, limit: _limit,isActive:  isActive);
    }
  }
  ...
  void _loadMoreVendors() async {
    ...
    if (response?.data?.data != null) {
      ...
      if (_currentPage < totalPages) {
        ...
        if (_selectedFilter == 'All') {
          await provider.getAllFranchiseListAtAdmin(
            context,
           page:  _currentPage,
           limit:  _limit,
           isActive:  null,
          ...
          IconButton(
            ...
            onPressed: () async  {
              final result = await Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => AddNewFranchisetAdminScreen(),
                ),
              );
        ...
        child: InkWell(
          ...
          onTap: () {
            ...
            showModalBottomSheet(
              ...
              builder: (context) => FranchiseDetailsBottomSheet(
                    ...
                    InkWell(
                      onTap: () async {
                        final result = await Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => UpdateFranchisetAdminScreen(vendorId: vendor.sId!),
                          ),
                        );
