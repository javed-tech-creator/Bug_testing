...
class AssetCard extends StatelessWidget {
  ...
  // const AssetCard({Key? key, required this.asset, this.onTap})
  //     : super(key: key);
  const AssetCard({
    Key? key,
    required this.asset,
        ...
        Container(
          ...
          decoration: BoxDecoration(
            gradient: LinearGradient(
              colors: [
                AssetUtils.getTypeColor(asset.type ?? '').withAlpha(20),
                AssetUtils.getTypeColor(asset.type ?? '').withAlpha(40),
              ],
            ),
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          if (_hasAMCContract &&
              asset.contractNo != null &&
              asset.contractNo!.isNotEmpty) ...[
