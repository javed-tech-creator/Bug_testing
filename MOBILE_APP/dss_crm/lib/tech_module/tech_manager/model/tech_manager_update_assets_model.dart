class TechMangerUpdateAssetModelResponse {
  bool? success;
  Data? data;
  String? message;

  TechMangerUpdateAssetModelResponse({this.success, this.data, this.message});

  TechMangerUpdateAssetModelResponse.fromJson(Map<String, dynamic> json) {
