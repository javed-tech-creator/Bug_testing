class TechMangerAssetAssignedModelResponse {
  bool? success;
  String? message;
  Data? data;

  TechMangerAssetAssignedModelResponse({this.success, this.message, this.data});

  TechMangerAssetAssignedModelResponse.fromJson(Map<String, dynamic> json) {
