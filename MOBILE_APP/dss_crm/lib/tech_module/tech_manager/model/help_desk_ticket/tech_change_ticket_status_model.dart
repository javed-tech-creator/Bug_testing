class UpdateTicketStatusModelResponse {
  bool? success;
  String? message;
  Data? data;

  UpdateTicketStatusModelResponse({this.success, this.message, this.data});

  UpdateTicketStatusModelResponse.fromJson(Map<String, dynamic> json) {
