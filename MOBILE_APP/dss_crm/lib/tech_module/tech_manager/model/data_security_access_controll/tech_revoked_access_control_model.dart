class TechRevokedAccessCotrolModelResponse {
  bool? success;
  String? message;
  Data? data;

  TechRevokedAccessCotrolModelResponse({this.success, this.message, this.data});

  TechRevokedAccessCotrolModelResponse.fromJson(Map<String, dynamic> json) {
