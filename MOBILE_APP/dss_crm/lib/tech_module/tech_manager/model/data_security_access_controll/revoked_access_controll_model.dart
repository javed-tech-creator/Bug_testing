class TechRecokedAccessControlModelResponse {
  bool? success;
  String? message;
  Data? data;

  TechRecokedAccessControlModelResponse(
      {this.success, this.message, this.data});

  TechRecokedAccessControlModelResponse.fromJson(Map<String, dynamic> json) {
