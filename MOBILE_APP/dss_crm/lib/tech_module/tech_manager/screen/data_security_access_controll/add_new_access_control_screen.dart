...
class TechManagerAddNewAccessControlScreen extends StatefulWidget {

  @override
  State<TechManagerAddNewAccessControlScreen> createState() => _TechManagerAddNewAccessControlScreenState();
}

class _TechManagerAddNewAccessControlScreenState extends State<TechManagerAddNewAccessControlScreen> {
  ...
  void _submitForm(TechManagerApiProvider provider) {
    if (_formKey.currentState?.validate() ?? false) {
      ...
      provider.addTechNewAccessControl(context, body);
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: DefaultCommonAppBar(
        activityName: "Add New Security & Access",
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Fill in the details to add a new access control to the system',
                  style: TextStyle(
                ...
                Consumer<TechManagerApiProvider>(
                  builder: (context, addAssetProvider, child) {
                    return Container(
                      ...
                      child: CustomButton(
                        color: Colors.orange,
                        text: addAssetProvider.isLoading ? 'Submitting...' : "Submit",
