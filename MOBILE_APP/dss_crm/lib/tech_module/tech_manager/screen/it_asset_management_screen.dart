...
class _AssetManagementScreenState extends State<AssetManagementScreen> {
  ...
  Future<void> loadAssets({bool isInitial = false}) async {
    ...
    try {
      await provider.getAllTechAssetsList(context, _currentPage, _itemsPerPage);

      final response = provider.getAllTechAssetsListModelResponse;
      ...
      if (_searchQuery.isNotEmpty) {
        filteredList = filteredList.where((asset) {
          ...
          return (asset.tag?.toLowerCase().contains(searchLower) ?? false) ||
              ...
              (asset.assignedTo?.toLowerCase().contains(searchLower) ??
                  false) ||
              (asset.department?.toLowerCase().contains(searchLower) ??
                  false) ||
  ...
  Widget _buildAssetsList() {
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        return AssetCard(asset: asset, onTap: () => _showAssetDetails(asset));
  ...
  void _showAssetDetails(Data asset) {
    showModalBottomSheet(
      ...
      builder: (context) => AssetDetailBottomSheet(
        asset: asset,
