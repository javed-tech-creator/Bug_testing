...
class AddNewAMCScreen extends StatefulWidget {
  ...
  @override
  State<AddNewAMCScreen> createState() => _AddNewAMCScreenState();
}

class _AddNewAMCScreenState extends State<AddNewAMCScreen> {
  ...
  void _submitForm(TechManagerApiProvider provider) {
    if (_formKey.currentState?.validate() ?? false) {
      ...
      provider.addTechNewVendorAMC(context, body);
    }
