...
class TechBaseDashboardScreen extends StatefulWidget {
  final String userRole;

  const TechBaseDashboardScreen({super.key, required this.userRole});

  @override
  State<TechBaseDashboardScreen> createState() => _TechBaseDashboardScreenState();
}

class _TechBaseDashboardScreenState extends State<TechBaseDashboardScreen> {
  final GlobalKey<ScaffoldState> _scaffoldKey = GlobalKey<ScaffoldState>();

  Widget? _selectedScreen;
  String selectedMenu = 'Technology Dashboard';
  bool _canPop = false;
  ...
  Widget _getDashboardScreen(String role) {
    switch (role) {
      case 'techManager':
        return const TechManagerDashboardScreen();
      case 'techEngineer':
    ...
    setState(() {
      switch (title) {
        ...
        case 'IT Asset Management':
          ...
          break;
        case 'Software & License Management':
          Navigator.push(
            context,
            MaterialPageRoute(builder: (_) => const LicenceSoftwareListScreen()),
          );
          break;
        case 'Networking & Infrastructure':
          Navigator.push(
            context,
            MaterialPageRoute(builder: (_) => const TechDevicesListScreen()),
          );
          break;
        case 'AMC Management':
          Navigator.push(
            context,
            MaterialPageRoute(builder: (_) => const TechVendorAMCListScreen()),
          );
          break;
        case 'Data Security & Access Control':
          Navigator.push(
            context,
            MaterialPageRoute(builder: (_) => const AccessControlListScreen()),
          );
          break;
        ...
        case 'Ticketing System':
          Navigator.push(
            context,
            MaterialPageRoute(builder: (_) => const TechHelpDeskTicketListScreen()),
          );
          break;
          //// TECH ENGINEER /.///////////////////////////////////
        ...
        case 'My Assets':
          Navigator.push(
            context,
            MaterialPageRoute(builder: (_) => const TechEngineerAssetManagementScreen()),
          );
          break;

        case 'My Software & License':
          Navigator.push(
            context,
            MaterialPageRoute(builder: (_) => const TechEngineerLicenceSoftwareManagementScreen()),
          );
          break;
        ...
        case 'My Assigned Tickets':
          Navigator.push(
            context,
            MaterialPageRoute(builder: (_) => const TechEngineerAssignedTicketListScreen()),
          );
          break;
