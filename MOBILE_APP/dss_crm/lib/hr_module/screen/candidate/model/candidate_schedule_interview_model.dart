class CandidateScheduleInterviewModelResponse {
  int? statusCode;
  bool? success;
  String? message;
  Data? data;
  ...
  CandidateScheduleInterviewModelResponse(
      {this.statusCode, this.success, this.message, this.data, this.timestamp});

  CandidateScheduleInterviewModelResponse.fromJson(Map<String, dynamic> json) {
