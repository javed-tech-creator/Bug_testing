class UploadCandidateOfferLetterResumeModelResponse {
  int? statusCode;
  bool? success;
  String? message;
  Data? data;
  ...
  UploadCandidateOfferLetterResumeModelResponse(
      {this.statusCode, this.success, this.message, this.data, this.timestamp});

  UploadCandidateOfferLetterResumeModelResponse.fromJson(
...
class Resume {
  ...
  Resume({this.url, this.publicUrl});
