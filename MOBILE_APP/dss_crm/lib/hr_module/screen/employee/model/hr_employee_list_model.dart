class HREmployeeListModelResponse {
  int? statusCode;
  bool? success;
  String? message;
  List<Data>? data;
  ...
  HREmployeeListModelResponse(
      {this.statusCode, this.success, this.message, this.data, this.timestamp});

  HREmployeeListModelResponse.fromJson(Map<String, dynamic> json) {
...
class BranchId {
  ...
  BranchId.fromJson(Map<String, dynamic> json) {
    sId = json['_id'];
    title = json['title'];  // This will be null if not present
  }
