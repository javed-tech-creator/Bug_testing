...
class HrProfilePage extends StatelessWidget {
  HrProfilePage({super.key});

  final UserProfile user = UserProfile(
    name: 'Kelly Aniston',
    email: 'kellyaniston@gmail.com',
    profileImage:
    "https://i.pravatar.cc/150?img=47", // 🔹 mock profile image (replace with API)
    sections: [
      Section(
        title: 'Account',
        items: [
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: SingleChildScrollView(
          child: Padding(
            padding: ResponsiveHelper.paddingSymmetric(context, horizontal: 16.0),
            child: Column(
                ...
                onTap: () {
                  if (item.title == 'Profile information') {
                    Navigator.of(context).push(
                      MaterialPageRoute(
                        builder: (context) =>  HRProfileInformationPage(),
                      ),
                    );
                  }
                },
