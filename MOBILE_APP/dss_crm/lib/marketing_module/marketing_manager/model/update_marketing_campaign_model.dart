class UpdateCampaignModelResponse {
  bool? success;
  String? message;
  Campaign? campaign;

  UpdateCampaignModelResponse({this.success, this.message, this.campaign});

  UpdateCampaignModelResponse.fromJson(Map<String, dynamic> json) {
