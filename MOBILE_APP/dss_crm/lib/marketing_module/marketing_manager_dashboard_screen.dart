...
class MarketingManagerDashboardScreen extends StatefulWidget {
  const MarketingManagerDashboardScreen({super.key});

  @override
  State<MarketingManagerDashboardScreen> createState() => _MarketingManagerDashboardScreenState();
}

class _MarketingManagerDashboardScreenState extends State<MarketingManagerDashboardScreen> {
                          ...
                          child: GestureDetector(
                            onTap: (){
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => AddNewCampaignFormScreen(),
                                ),
                              );
                            },
                            child: Container(
