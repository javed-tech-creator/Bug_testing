...
class SalesTLLeadManagementFormScreen extends StatefulWidget {
  final leadModel.Result leadData;

  const SalesTLLeadManagementFormScreen({super.key, required this.leadData});

  @override
  State<SalesTLLeadManagementFormScreen> createState() => _SalesTLLeadManagementFormScreenState();
}

class _SalesTLLeadManagementFormScreenState extends State<SalesTLLeadManagementFormScreen> {
