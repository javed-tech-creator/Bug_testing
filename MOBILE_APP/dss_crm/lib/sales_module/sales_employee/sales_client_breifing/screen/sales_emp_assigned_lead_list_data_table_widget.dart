...
class SalesEmpAssignedLeadLeadAction {
...
class SalesEmpAssignedLeadListDataTable extends StatefulWidget {
  ...
  @override
  State<SalesEmpAssignedLeadListDataTable> createState() => _SalesEmpAssignedLeadListDataTableState();
}

class _SalesEmpAssignedLeadListDataTableState extends State<SalesEmpAssignedLeadListDataTable> {
  bool _isDescending = true;
  late String userRole; // Changed to late to indicate it will be initialized
  ...
  void loadUserData() async {
    ...
    // You might want to call setState here if you use userRole to conditionally build UI
    // setState(() {});
  }
                ...
                rows: List.generate(sortedLeads.length, (index) {
                  ...
                  return DataRow(
                    ...
                    cells: [
                      ...
                      DataCell(
                        Text(
                          DateFormatterUtils.formatUtcToReadable(lead.updatedAt ?? "-"),
