...
class VendorAddProductScreen extends StatefulWidget {
  ...
  //
  // const VendorAddProductScreen({Key? key, required this.productData})
  //     : super(key: key);
...
class _VendorAddProductScreenState extends State<VendorAddProductScreen> {
  ...
  Future<void> _handleUpdateProduct() async {
    ...
    await Provider.of<VendorModuleApiProvider>(context, listen: false).addVendorProduct(context, updateBody);
