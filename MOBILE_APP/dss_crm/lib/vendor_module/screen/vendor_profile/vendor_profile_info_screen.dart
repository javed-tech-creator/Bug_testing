...
class VendorProfileInformationPage extends StatefulWidget {
  const VendorProfileInformationPage({super.key});

  @override
  State<VendorProfileInformationPage> createState() =>
      _VendorProfileInformationPageState();
}

class _VendorProfileInformationPageState
    extends State<VendorProfileInformationPage> {
  @override
  void initState() {
    super.initState();
