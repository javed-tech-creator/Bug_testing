...
/// ---------------------- SCREEN ----------------------
class VendorCreateInvoiceScreen extends StatefulWidget {
  ...
  @override
  State<VendorCreateInvoiceScreen> createState() =>
      _VendorCreateInvoiceScreenState();
}

class _VendorCreateInvoiceScreenState extends State<VendorCreateInvoiceScreen> {
  ...
  Future<void> _handleCreateInvoice() async {
    ...
    final result = await apiProvider.createInvoice(context, invoiceBody);
                            ...
                            children: [
                              ...
                              Row(
                                children: [
                                  ...
                                  Container(
                                    height: 40, // Same as quantity container height
                                    decoration: BoxDecoration(
                                      borderRadius: BorderRadius.circular(4),
                                      border: Border.all(color: Colors.grey.shade300),
                                    ),
...
// E-commerce style summary row
  Widget _buildEcommerceSummaryRow(String label, String value, bool isBold, {bool isGreen = false}) {
    return Row(
      mainAxisAlignment: MainAxisAlignment.spaceBetween,
      children: [
        Text(
            ...
            child: Column(
              ...
              children: [
                ...
                if (_invoiceItems.isNotEmpty)
                  Padding(
                    padding: ResponsiveHelper.paddingSymmetric(context,horizontal: 16.0,vertical: 2),
                    child: Row(
                      children: [
                        Icon(
                          Icons.receipt_long,
